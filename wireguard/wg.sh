...
# ==================================================
# Link Hosting Kalian
fisabiliyusri="raw.githubusercontent.com/Haris131/autoscriptvps/main/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/Haris131/autoscriptvps/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/Haris131/autoscriptvps/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/Haris131/autoscriptvps/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
